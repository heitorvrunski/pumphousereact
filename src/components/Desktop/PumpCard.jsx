    ...
    <div className="mb-2">
      ...
      <div className="d-flex flex-row">
        <div className="d-flex flex-column">
          ...
          <div className="card p-2 d-flex  position-relative justify-content-start flex-row " style={{"height":"72px"}}>
        ...
        <div className="card p-2 ps-0 d-flex  position-relative justify-content-start flex-row mx-2 " style={{"maxWidth":"300px","minWidth":"220px"}}>

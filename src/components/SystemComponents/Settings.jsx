...
export default function Config() {
  ...
  return (
    <div className="row justify-content-center  d-flex text-Light h-100" >
      <div className="card h-100 d-flex flex-column position-relative" style={{ minWidth: "320px","maxWidth":"720px" }}>
        <div className="m-2 d-flex justify-content-between">
          ...
          <svg className="btn-Icon position-absolute top-0 end-0 me-2 mt-2" style={{opacity:"0.7"}} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"  fill="#f0f0f0" onClick={()=>history.push("/Settings/config")}>
        ...
        <Table
          ...
          classTable={" text-Light mb-0 ms-1 overflow-auto "+(ismobile?"flex-row":"flex-column")}

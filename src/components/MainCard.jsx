                        ...
                        <div className="col col-xl-7 col-md-7" style={{minWidth:"330px",maxWidth:'330px'} }>
                            <div className="d-block" style={{ "width": "305px", "height": "430px", }}>
                                <div className="position-absolute water-Tank-Box  ms-5 ">
                                    <div className="w-100 water-Tank mt-1" style={{ height: Tags.cLevel.Percentage+"%" }}></div>
                                </div>
                                <div className="position-absolute ms-5 pumps-Images">
                                    <div className="row">
                                        ...
                                        <div className=" pump-horizontal-div mb-0 p-0">
                                            ...
                                            <span className="bg-white d-inline-flex border px-2 text-info "><h6><b>{Tags.PressurePID.Current} PSIG</b></h6></span>
                                            </div>
                                    ...
                                    <div className="row mx-2">
                                        <div className="col px-1">
                                            ...
                                            <PumpImage cPump={Tags.cPump[0]}  width="64px" className="mx-0"/>

                                        </div>
                                        <div className="col px-1">
                                            <div className="pump-vertical-Pipe"></div>

                                            <PumpImage cPump={Tags.cPump[1]}  width="64px" className="mx-0"/>

                                        </div>
                                        <div className="col px-1">
                                            <div className="pump-vertical-Pipe"></div>
                                            <PumpImage cPump={Tags.cPump[2]}  width="64px" className="mx-0"/>

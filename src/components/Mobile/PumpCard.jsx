...
export default function PumpCard(props) {
  ...
  return (
    <div className="card p-2 d-flex  position-relative justify-content-start flex-row mb-2">
      ...
      //className={"mx-3 " +(props.cPump.StatusOPC===2?"pump-gray blink-yellow":(props.cPump.StatusOPC===1?"pump-green":"pump-red"))} id="Layer_1"
      ...
      <div>
        ...
        <div className="d-flex flex-row">
          ...
          <h6 className="text-Light p-0 m-0 f-400">
            Freq: {props.cPump.FrequencyStatus} Hz
          </h6>
        </div>
        {props.cPump.B7OPC ===0?
      <div>

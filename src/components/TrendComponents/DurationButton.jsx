...
export default function DurationButton(props){
    ...
    return(
    <div className={"d-inline-block align-middle m-1 " +(props.className??'')}  onClick={handleChange}>
        <div className={"btn text-center align-middle p-0 flex-nowrap" +(selected===true?' selectedDuration':'')} style={{height:"30px",width:"105px"}}>
